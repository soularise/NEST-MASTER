...
namespace NEST.Controllers.Common
{
    public class NGPAPI
    {
        ...
        public void postUserToNGP(Registrant registrant)
        {
            ...
            Post = Post + "<credentials>" + strCredentials + "</credentials>" + MyRequest + "</EmailSignUp>";
            ...
            string loggingIsOn = ConfigurationManager.AppSettings["LoggingIsOn"];
            // log the content.
            if (loggingIsOn.ToLower() == "true")
            {
